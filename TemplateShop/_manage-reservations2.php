...
if(isset($_POST['update_res'])){
	...
	$result = mysqli_query($con,"UPDATE reservation SET pickupdate='$pickup', returndate='$return', overall_price='$price' WHERE id='$id'");
                ...
                <div class="modal fade" tabindex="-1" id="editReservationModal" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row justify-content-between ml-1">
                                        <div class="input-box">
                                            ...
                                            <br>
                                            <input type="datetime-local" name="pickup1" id="pickup1"
                                    ...
                                    <div class="row justify-content-between ml-1 mt-2">
                                        <div class="input-box">
                                            ...
                                            <br>
                                            <input type="datetime-local" name="return1" id="return1"
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="update_res" id="update_res"
